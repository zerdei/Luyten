...
public class JavaLanguage extends Language {
	...
	@Override
	public JavaTypeDecompilationResults decompileType(final TypeDefinition type, final ITextOutput output,
	...
	private JavaTypeDecompilationResults runTransformsAndGenerateCode(
		...
		return new JavaTypeDecompilationResults(lineNumberPositions, astBuilder.getCompilationUnit());
	}
}
